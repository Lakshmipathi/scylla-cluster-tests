...
def call(Map pipelineParams) {
    ...
    pipeline {
        ...
        parameters {
            ...
            separator(name: 'SCYLLA_DB_VERSION', sectionHeader: 'ScyllaDB Version Configuration')
            string(name: 'scylla_version', defaultValue: '', description: 'Version of ScyllaDB (Must specify either version or repository)')
            string(name: 'scylla_repo',defaultValue: '', description: 'Repository for ScyllaDB (Must specify either repository or version)')
