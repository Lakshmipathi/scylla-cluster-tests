...
class ClusterTester(db_stats.TestStatsMixin, unittest.TestCase):
    ...
    def prepare_azure_kms(self) -> None:
        ...
        self.log.info(f"Azure KMS evaluation: scylla_version={scylla_version}, version_supports_kms={version_supports_kms}, should_enable_kms={should_enable_kms}, enterprise_disable_kms={self.params.get('enterprise_disable_kms')}")
