...
class ProvisionerFactory:
    ...
    def create_provisioner(self, backend: str, test_id: str, region: str, n_db_nodes: int, availability_zone: str, **config) -> Provisioner:
        ...
        return provisioner(test_id, region, n_db_nodes, availability_zone, **config)
